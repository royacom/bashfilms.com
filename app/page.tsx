...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5;">
  ...
  return (
    <div className="mx-auto max-w-4xl p-4 sm:p-8 pt-16 sm:pt-16 md:pt-8 md:pb-8">
      {/* Sticky Starting Price (desktop top-right) - hidden when in iframe, parent handles it */}
      {!isInIframe && (
      ...
      {/* Sticky Starting Price (mobile top bar) - hidden when in iframe, parent handles it */}
      {!isInIframe && (
        <div
